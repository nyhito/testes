-- AUTO WALLHOP + DOUBLE JUMP (FLICK VISUAL SEM QUEBRAR FÍSICA - 90° EM 0.10s)
...
local function performVideoFlick()
    ...
    -- velocidade ajustada pra ~90° em 0.10s
...
print("WallHop Loaded (flick 90° em 0.10s)")
