...
UserInputService.JumpRequest:Connect(function()
    ...
    if doubleJumpReady then
        doubleJumpReady = false -- precisa carregar dnv
...
print("WallHop Loaded (Sistema de carga por wallhop)")
