-- AUTO WALLHOP + DOUBLE JUMP (FLICK 90° EM 0.20s)
...
local function performVideoFlick()
	...
	-- 90° em 0.20s (velocidade ajustada)
	hrp.AssemblyAngularVelocity = Vector3.new(0, math.rad(360), 0)
...
print("WallHop Loaded (90° em 0.20s)")
